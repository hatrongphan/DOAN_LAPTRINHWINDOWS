...
namespace QLNV
{
    ...
    public partial class FrmMain : Form
    {
        ...
        private QLNV.Entities.NhanVienLogin nvlogin = null;
        ...
        private void SuccessLogin(QLNV.Entities.NhanVienLogin nv) {
            this.nvlogin = nv;
            DangNhap(true);
        ...
        {
            MessageBox.Show("Đồ Án: PHẦN MỀM QUẢN LÝ NHÂN VIÊN CÔNG TY CNTT.\n\n Nhóm sinh viên thực hiện: \n1. Hà Trọng Phan | 1824801040082\n2. Đinh Thị Kim Tới | 1824801040128","Giới thiệu");
        }
